...
function init() {
    ...
    plane = new THREE.Mesh(geometry1, new THREE.MeshBasicMaterial({ visible: false }));
    scene.add(plane);
...
function getText2(text, answer) {
    ...
    dynamicTexture1.drawText(text2, undefined, positionText2, '#707070');
    dynamicTexture1.context.font = "60px " + answer;
    dynamicTexture1.drawText(text2, undefined, positionText2, 'black');
...
function getText3(text, answer) {
    ...
    dynamicTexture2.drawText(text3, undefined, positionText3, '#707070');
    dynamicTexture2.context.font = "60px " + answer;
    dynamicTexture2.drawText(text3, undefined, positionText3, 'black');
